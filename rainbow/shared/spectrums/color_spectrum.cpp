...
rainbow::spectrums::color_spectrum::color_spectrum(const std::vector<real>& lambda, const std::vector<real>& value)
{
	real x = 0, y = 0, z = 0;
...
rainbow::spectrums::color_spectrum rainbow::spectrums::color_spectrum::from_xyz(real x, real y, real z)
{
