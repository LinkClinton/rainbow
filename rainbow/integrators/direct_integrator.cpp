...
rainbow::spectrum rainbow::integrators::direct_integrator::trace(
...
rainbow::integrators::sampler_group rainbow::integrators::direct_integrator::prepare_samplers(uint64 seed)
{
