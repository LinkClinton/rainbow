...
rainbow::cpus::scatterings::reflection_function::reflection_function(
...
rainbow::cpus::scatterings::scattering_sample rainbow::cpus::scatterings::reflection_function::sample(
...
rainbow::core::real rainbow::cpus::scatterings::reflection_function::pdf(const vector3& wo, const vector3& wi) const
{
	return same_hemisphere(wo, wi) ? cosine_sample_hemisphere_pdf(math::abs(cos_theta(wi))) : 0;
}
