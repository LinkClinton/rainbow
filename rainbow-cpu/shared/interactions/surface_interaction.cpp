...
rainbow::cpus::shared::interactions::surface_interaction::surface_interaction(const std::shared_ptr<const scenes::entity>& entity) :
...
rainbow::core::math::vector3 rainbow::cpus::shared::interactions::surface_interaction::from_space_to_world(const vector3& v) const noexcept
{
	return local_to_world(shading_space, v);
}

rainbow::core::math::vector3 rainbow::cpus::shared::interactions::surface_interaction::from_world_to_space(const vector3& v) const noexcept
{
