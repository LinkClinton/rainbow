...
rainbow::interactions::surface_interaction::surface_interaction() :
	index(0), dp_du(0), dp_dv(0), uv(0)
{
}

rainbow::interactions::surface_interaction::surface_interaction(const std::shared_ptr<const scenes::entity>& entity, size_t index) :
	entity(entity), index(index), dp_du(0), dp_dv(0), uv(0)
{
}
...
rainbow::interactions::surface_interaction::surface_interaction(
	...
	entity(entity), index(index), dp_du(dp_du), dp_dv(dp_dv), uv(uv)
{
...
rainbow::interactions::surface_interaction::surface_interaction(
	...
	size_t index) :
	interaction(normal, point, wo),
	shading_space(shading_space), entity(entity), index(index), dp_du(dp_du), dp_dv(dp_dv), uv(uv)
{
}
